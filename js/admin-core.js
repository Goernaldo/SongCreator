(function () {
  ...
  function defaults() {
    return {
      ...
      shop: { currency: 'EUR', monthlyPrice: 9.99, yearlyPrice: 89.99, trialDays: 3, yearlySavingsText: true, shopEnabled: false, monthlyEnabled: true, yearlyEnabled: true, benefits: ['Unbegrenzte Themen','Bis zu 5 Genres','Bis zu 5 Vocals','Bis zu 5 Stimmungen','Premium Prompt-Pakete','Zukünftige KI-Funktionen','Premium Cover'], description: 'Mehr Freiheit für deine Musik.', promotionalPrice: null, discountPercent: 0, promotionStart: '', promotionEnd: '', coupons: [], discounts: [], stripePlaceholder: '', paypalPlaceholder: '', invoiceStatus: 'vorbereitet', subscriptionStatus: 'inaktiv' },
